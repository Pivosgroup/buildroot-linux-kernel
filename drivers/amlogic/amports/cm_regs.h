...
#define SAT_CENTRAL_EN_BIT  25 //2'b01 central biggest   2'b00 one side biggest
#define SAT_CENTRAL_EN_WID   2
#define SAT_SHAPE_BIT       24 //1'b1: left side biggest 1'b0 right side biggest
#define SAT_SHAPE_WID        1
#define SAT_GAIN_BIT        16
#define SAT_GAIN_WID         8
#define HUE_EN_BIT          15
#define HUE_EN_WID           1
#define HUE_CLOCKWISE_BIT   11 //1'b1: clockwise 1'b0: anti-clockwise
#define HUE_CLOCKWISE_WID    1
#define HUE_CENTRAL_EN_BIT   9 //1'b1: parabola curve    1'b0: non-symmetry curve
#define HUE_CENTRAL_EN_WID   2
#define HUE_SHAPE_BIT        8 //1'b1: right side change more    1'b0: left side change more
#define HUE_SHAPE_WID        1
#define HUE_GAIN_BIT         0 //0x00-0x80, note: should be no bigger than 0x80
...
#define HUE_SHF_RAN_BIT     16 //0x08-0xff,(0x100 means 120 degree though it can not be set)
#define HUE_SHF_RAN_WID      8
#define SYM_EN_BIT          15
#define SYM_EN_WID           1
#define HUE_SHF_STA_BIT      0 //0x6000 means 360 degree, only region 0 and 1 can exceed 360 degree
...
#define HUE_SHF_RAN_INV_BIT  0 //HUE_SHF_RAN_INV = ((1<<20)/HUE_SHF_RAN+1)>>1
...
#define HUE_LUM_H_SLOPE_BIT 20 //0x00-0x07
#define HUE_LUM_H_SLOPE_WID  4
#define HUE_LUM_L_SLOPE_BIT 16 //0x00-0x07
...
#define HUE_SAT_H_SLOPE_BIT 20 //0x00-0x07
#define HUE_SAT_H_SLOPE_WID  4
#define HUE_SAT_L_SLOPE_BIT 16 //0x00-0x07
...
#define SAT_LUM_H_SLOPE_BIT 28 //0x00-0x07
#define SAT_LUM_H_SLOPE_WID  4
#define SAT_LUM_L_SLOPE_BIT 24 //0x00-0x07
#define SAT_LUM_L_SLOPE_WID  4
#define SAT_SAT_H_SLOPE_BIT 20 //0x00-0x07
#define SAT_SAT_H_SLOPE_WID  4
#define SAT_SAT_L_SLOPE_BIT 16 //0x00-0x07
...
#define SAT_SEL_BIT          6 //1'b1: uv_max(default)   1'b0: u^2+v^2
