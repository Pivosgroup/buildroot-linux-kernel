...
#define VDIN_MEM_SIZE       U_ALIGN(24*SZ_1M)

#define VDIN0_ADDR_START	U_ALIGN(DI_ADDR_END)
#define VDIN0_ADDR_END		(VDIN0_ADDR_START + VDIN_MEM_SIZE - 1)
#define VDIN1_ADDR_START	U_ALIGN(VDIN0_ADDR_END)
#define VDIN1_ADDR_END		(VDIN1_ADDR_START + VDIN_MEM_SIZE - 1)



#define RESERVED_MEM_END	(VDIN1_ADDR_END)
