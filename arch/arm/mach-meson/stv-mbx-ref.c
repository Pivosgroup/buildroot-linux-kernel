...
static struct adc_key adc_kp_key[] = {
    {KEY_ESC,          "exit",  CHAN_4, 0, 60},
    {KEY_F1,          "menu",  CHAN_4, 124, 60},
    {KEY_LEFT,          "left",  CHAN_4, 247, 60},
    {KEY_DOWN,          "down",  CHAN_4, 371, 60},
    {KEY_RIGHT,         "right", CHAN_4, 495, 60},
    {KEY_ENTER,         "enter", CHAN_4, 619, 60},
    {KEY_UP,            "up",    CHAN_4, 745, 60},
};
...
struct aml_nand_device aml_nand_mid_device_m3 = {
...
static struct platform_device aml_nand_device = {
	...
	.dev = {
		.platform_data = &aml_nand_mid_device_m3,
	},
};
#endif
...
static struct android_usb_platform_data android_usb_pdata = {
       ...
       .product_id     = 0x0c01,
       .version        = 0x0100,
       .product_name   = "MBX_REF",
       .manufacturer_name = "AMLOGIC",
       .serial_number  = "ADB_REF",
